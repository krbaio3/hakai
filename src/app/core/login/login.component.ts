      ...
      .then(response => {
        ...
        this.authService.login().subscribe(() => {
          ...
          if (this.authService.isLoggedIn) {
            ...
            // Revisar esta parte y refactorizar para que haga bien el if
            // hay que externalizar la parte de la ruta para que sea manejado por la app
            // y no haya que reconfigurar/manipular el modlo Core
